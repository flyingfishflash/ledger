package net.flyingfishflash.ledger.integration.domain.accounts.nestedset.jpa;
...
import net.flyingfishflash.ledger.integration.domain.accounts.nestedset.base.TestHelper;
...
public class JpaTestHelper implements TestHelper {
  ...
  public TestNode getParent(TestNode f) {
    ...
    System.out.println(
        String.format(
            "Parent of %s is %s", f.getName(), parent != null ? parent.getName() : "null"));
    return parent;
  }
  ...
  public void breakTree() {
    this.em
        .createQuery(
            "update TestNode set treeLeft = 0, treeRight = 0, treeLevel = 0 where discriminator = 1")
        .executeUpdate();
  }
  ...
  public void resetParent(String symbol) {
    this.em
        .createQuery(
            "update TestNode set parentId = null where name='" + symbol + "' and discriminator = 1")
        .executeUpdate();
  }

  @Override
  public void removeTree() {
    this.em.createQuery("delete from TestNode where discriminator = 1").executeUpdate();
  }
